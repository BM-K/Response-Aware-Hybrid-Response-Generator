...
class Arguments():
    ...
    def add_hyper_parameters(self):
        ...
        self.add_argument('--n_beams', type=int, default=5)
        self.add_argument('--min_length', type=int, default=3)
        self.add_argument('--embedding_dim', type=int, default=768)

    def add_data_parameters(self):
        self.add_argument('--test_data', type=str, default='data/base_food_test.tsv')
        self.add_argument('--corpus_v1', type=str, default='data/')
        self.add_argument('--corpus_v2', type=str, default='data/')
        self.add_argument('--retrieval_ckpt', type=str, default='models/outputs/base_food_ret.pt')
        self.add_argument('--generative_ckpt', type=str, default='models/outputs/base_food_f3.pt')
